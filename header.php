...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <a class="navbar-brand brand-logo mr-5" href="assets/index.html"><img src="assets/images/logo.svg" class="mr-2" alt="logo"/></a>
    ...
    <ul class="navbar-nav navbar-nav-right">
        ...
        <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="assets/#" data-toggle="dropdown">
        ...
        <a class="nav-link dropdown-toggle" href="assets/#" data-toggle="dropdown" id="profileDropdown">
            <img src="assets/images/Rizki.jpg" alt="profile"/>
        </a>
...
<div class="container-fluid page-body-wrapper">
    ...
    <div class="tab-content" id="setting-content">
        ...
        <ul class="chat-list">
            ...
            <div class="profile"><img src="assets/images/Foto/Ade.jpg" alt="image"><span class="online"></span></div>
            <div class="info">
                <p>Ade Putra Sondakh</p>
                <p>Available</p>
            </div>
            <small class="text-muted my-auto">19 min</small>
            </li>
            <li class="list">
            <div class="profile"><img src="assets/images/Foto/Yusuf.jpg" alt="image"><span class="offline"></span></div>
            <div class="info">
